...
urlpatterns = [
    ...
    path('postcards/<int:postcard_id>/disassoc_location/<int:location_id>/', views.disassoc_location, name='disassoc_location'),
    ...
    # path('locations/', views.locations_index, name='index'),
    path('postcards/<int:postcard_id>/assoc_location/<int:location_id>/', views.assoc_location, name='assoc_location'),
